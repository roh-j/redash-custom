...
describe("Visualizations -> Custom Table -> Columns -> Boolean", () => {
  describe("Editor", () => {
    test("Changes value for FALSE", done => {
      ...
      findByTestID(el, "CustomTable.ColumnEditor.Boolean.False")
        .last()
        .find("input")
    ...
    test("Changes value for TRUE", done => {
      ...
      findByTestID(el, "CustomTable.ColumnEditor.Boolean.True")
        .last()
        .find("input")
